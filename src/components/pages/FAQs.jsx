    ...
    <div className="faqs">
      ...
      <div className="d-flex-r">
        <div className="d-flex-col">
          ...
          <h2>Should I bring a frisbee?</h2>
          <p>If it is made by Wham-O, you should probably leave it at home.</p>
          <h2>Do I have to pay anything to play?</h2>
          <p>
            Yes, we participate in the Fairfax Ultimate highschool leagues. We
            will also go to a few tournaments each semester, but they aren't too
            expesive
          </p>
